...
<ul>
    ...
    <li>Potentially-relevant topics are highlighted in our other project articles:
        <ul>
            ...
            <li><b>RDF, SPARQL, vocabularies</b>: <a href="https://doi.org/10.1371/journal.pcbi.1004989" target="_blank">Waagmeester A, et al. <b>(2016)</b> Using the semantic web for rapid integration of WikiPathways with other biological online data resources. <i>PLoS Comput Biol</i></a>.</li>
            <li><b>Nanopublications</b>: <a href="https://doi.org/10.1371/journal.pcbi.1004989" target="_blank">Kuhn T, et al. <b>(2018)</b> Nanopublications: A Growing Resource of Provenance-Centric Scientific Linked Data. <i>2018 IEEE 14th International Conference on e-Science (e-Science)</i></a>.</li>
