...
```
## Error in ggplot(combo.df): could not find function "ggplot"
```
...
```
## Error in ggsave("../assets/img/main_stats.png", plot = last_plot(), width = 650, : could not find function "ggsave"
```
...
```
## Error in ggplot(combo.df.anim): could not find function "ggplot"
```
