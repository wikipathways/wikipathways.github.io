...
<ul>
    ...
    <li>This website <b>contains only approved pathways</b> that have undergone review. Consequently, newly uploaded pathways will be immediately available on the classic site (<a href="https://www.wikipathways.org/" target="_blank">https://www.wikipathways.org/</a>), but will not be visible on this site until they are completed and approved. Note that searching your new pathway on this website is delayed untill the pathway is properly indexed by third-parties, you can try to locate your pathway by replacing the WP identifier (WP1) in this URL with your own: https://www.wikipathways.org//pathways/WP1.html. Once a pathway is uploaded to WikiPathways classic, the process of including them on the new site is as follows:</li>
        <ul>
