...
communities: []
description: 'Process describing the cardiovascular signalling pathway, reacting to
  ECM-receptor interactions, Wnt ligands binding to the Frizzled Receptor, and cytokine
  interactions. '
...
- '@context': https://schema.org/
  ...
  creator:
    '@type': Organization
    name: WikiPathways
  description: 'Process describing the cardiovascular signalling pathway, reacting
    to ECM-receptor interactions, Wnt ligands binding to the Frizzled Receptor, and
