...
description: During pregnancy, iron is transported from mother to fetus across the
  ...
  fetus.   Proteins on this pathway have targeted assays available via the [CPTAC
  Assay Portal](https://assays.cancer.gov/available_assays?wp_id=WP2007).
...
- '@context': https://schema.org/
  ...
  description: During pregnancy, iron is transported from mother to fetus across the
    ...
    the fetus.   Proteins on this pathway have targeted assays available via the [CPTAC
    Assay Portal](https://assays.cancer.gov/available_assays?wp_id=WP2007).
  keywords:
  - FeII
  - FeIII
