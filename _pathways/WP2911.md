...
- link: PMC12448840
  title: 'GNNenrich: a novel method for pathway enrichment analysis based on graph
    neural network (2025)'
- link: PMC10491796
  title: Oxidative stress mediates the inhibitory effects of Manzamine A on uterine
    leiomyoma cell proliferation and extracellular matrix deposition via SOAT inhibition
    (2023)
- link: PMC10266291
