...
citedin: ''
communities: []
description: 'PG cytoplasmic synthesis and recycling pathways in *E. coli*. The cytoplasmic
  pathways only. Membrane & periplasmic pathways are incomplete. '
...
- '@context': https://schema.org/
  ...
  creator:
    '@type': Organization
    name: WikiPathways
  description: 'PG cytoplasmic synthesis and recycling pathways in *E. coli*. The
    cytoplasmic pathways only. Membrane & periplasmic pathways are incomplete. '
  keywords:
  - 1,6-anhMurNAc
