...
- '@context': https://schema.org/
  ...
  description: Photochemical synthesis of vitamin D3 (cholecalciferol, D3) occurs
    ...
    on this pathway have targeted assays available via the [CPTAC Assay Portal](https://assays.cancer.gov/available_assays?wp_id=WP1531).
  keywords:
