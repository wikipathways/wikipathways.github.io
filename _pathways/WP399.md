...
description: This pathway was adapted from several resources and is designed to provide
  ...
  have targeted assays available via the [https://assays.cancer.gov/available_assays?wp_id=WP399
  CPTAC Assay Portal].
...
- '@context': https://schema.org/
  ...
  description: This pathway was adapted from several resources and is designed to
    ...
    on this pathway have targeted assays available via the [https://assays.cancer.gov/available_assays?wp_id=WP399
    CPTAC Assay Portal].
  keywords:
  - APC
  - AXIN1
