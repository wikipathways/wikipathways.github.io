...
- link: PMC3677916
  title: Liver transcriptome changes in zebrafish during acclimation to transport-associated
    stress (2013)
communities: []
description: NetPath 18 - IL-6 signaling pathway. [NetPath](http://www.netpath.org)
  is a collaborative project between [PandeyLab](http://pandeylab.igm.jhmi.edu) at
  Johns Hopkins University and the [Institute of Bioinformatics](http://www.ibioinformatics.org).
  If you use this pathway, you must cite the NetPath website until the pathway is
  published.
...
- '@context': https://schema.org/
  ...
  description: NetPath 18 - IL-6 signaling pathway. [NetPath](http://www.netpath.org)
    ...
    at Johns Hopkins University and the [Institute of Bioinformatics](http://www.ibioinformatics.org).
    If you use this pathway, you must cite the NetPath website until the pathway is
    published.
  keywords:
  - BAD
