...
description: 'This pathway shows the biotransformation of the chemotherapy prodrug
  ...
  of ABCB1 variants in toxicity.  Source: [PharmGkb](http://www.pharmgkb.org/search/pathway/irinotecan/liver.jsp).  Proteins
  on this pathway have targeted assays available via the [CPTAC Assay Portal](https://assays.cancer.gov/available_assays?wp_id=WP229).'
...
- '@context': https://schema.org/
  ...
  description: 'This pathway shows the biotransformation of the chemotherapy prodrug
    ...
    the roles of ABCB1 variants in toxicity.  Source: [PharmGkb](http://www.pharmgkb.org/search/pathway/irinotecan/liver.jsp).  Proteins
    on this pathway have targeted assays available via the [CPTAC Assay Portal](https://assays.cancer.gov/available_assays?wp_id=WP229).'
  keywords:
  - ABCC1
  - ABCC2
