...
- link: PMC8743585
  title: Clinical and Molecular Characteristics of PRKACA L206R Mutant Cortisol-Producing
    Adenomas in Korean Patients (2021)
- link: PMC12593800
...
- link: PMC13255878
  title: 'Attenuation of Immune Senescence Markers After Intensive Cancer Therapy
    Through Resistance Training: A Pilot Study (2026)'
communities:
- ONTOX
description: 'WNT signal, through the canonical pathway, controls cell fate determination
  ...
  and carcinogenic metastasis.    Please access this pathway at [NetSlim](http://www.netpath.org/netslim/wnt_pathway.html)
  ...
  Biology</i>. 11:R3.  This pathway is part the [CPTAC Assay Portal](https://assays.cancer.gov/available_assays?wp_id=WP363).'
...
- '@context': https://schema.org/
  ...
  description: 'WNT signal, through the canonical pathway, controls cell fate determination
    ...
    access this pathway at [NetSlim](http://www.netpath.org/netslim/wnt_pathway.html)
    database.  If you use this pathway, please cite the following paper: Kandasamy,
    K., Mohan, S. S., Raju, R., Keerthikumar, S., Kumar, G. S. S., Venugopal, A. K.,
    Telikicherla, D., Navarro, J. D., Mathivanan, S., Pecquet, C., Gollapudi, S. K.,
    Tattikota, S. G., Mohan, S., Padhukasahasram, H., Subbannayya, Y., Goel, R., Jacob,
    ...
    pathways. <i>Genome Biology</i>. 11:R3.  This pathway is part the [CPTAC Assay
    Portal](https://assays.cancer.gov/available_assays?wp_id=WP363).'
  keywords:
  - AKT1
  - APC
  - ARRB2
  ...
  - TSC2
  license: CC0
  name: Wnt signaling, NetPath
seo: CreativeWork
title: Wnt signaling, NetPath
wpid: WP363
---