...
description: This pathway is modeled after Figure 5 of the article "Glomerulocystic
  ...
  defects.  Proteins on this pathway have targeted assays available via the [CPTAC
  Assay Portal](https://assays.cancer.gov/available_assays?wp_id=WP4150).
...
- '@context': https://schema.org/
  ...
  description: This pathway is modeled after Figure 5 of the article "Glomerulocystic
    ...
    assays available via the [CPTAC Assay Portal](https://assays.cancer.gov/available_assays?wp_id=WP4150).
  keywords:
  - CTNNB1
  - Calcium
  - DVL1
