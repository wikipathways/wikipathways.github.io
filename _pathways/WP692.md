...
description: Metabolism of xenobiotic compounds consists of phase I and a phase II
  ...
  via the [CPTAC Assay Portal](https://assays.cancer.gov/available_assays?wp_id=WP692).
...
- '@context': https://schema.org/
  ...
  description: Metabolism of xenobiotic compounds consists of phase I and a phase
    ...
    assays available via the [CPTAC Assay Portal](https://assays.cancer.gov/available_assays?wp_id=WP692).
  keywords:
  - ADP
  - APS
  - ATP
