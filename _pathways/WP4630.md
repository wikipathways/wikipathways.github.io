...
description: 'The measles virus is a single-stranded, negative-sense virus that exclusively
  ...
  pathway is based on [KEGG](https://www.genome.jp/kegg-bin/show_pathway?hsa05162).  Protein
...
- '@context': https://schema.org/
  ...
  description: 'The measles virus is a single-stranded, negative-sense virus that
    ...
    as N proteins from infected cells.  This pathway is based on [KEGG](https://www.genome.jp/kegg-bin/show_pathway?hsa05162).  Protein
    phosphorylation sites were added based on information from PhosphoSitePlus (R),
    www.phosphosite.org.'
  keywords:
  - ADAR
