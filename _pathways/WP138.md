...
description: 'Androgens, mainly testosterone and 5alpha-dihydrotestosterone (DHT)
  ...
  associated with prostate cancer.  Please access this pathway in the [NetSlim](http://www.netpath.org/netslim/ar_pathway.html)
  ...
  the [CPTAC Assay Portal](https://assays.cancer.gov/available_assays?wp_id=WP138)'
...
- '@context': https://schema.org/
  ...
  description: 'Androgens, mainly testosterone and 5alpha-dihydrotestosterone (DHT)
    ...
    access this pathway in the [NetSlim](http://www.netpath.org/netslim/ar_pathway.html)
    database.  If you use this pathway, please cite following paper: Kandasamy, K.,
    Mohan, S. S., Raju, R., Keerthikumar, S., Kumar, G. S. S., Venugopal, A. K., Telikicherla,
    ...
    via the [CPTAC Assay Portal](https://assays.cancer.gov/available_assays?wp_id=WP138)'
  keywords:
  - AES
  - AKT1
  - AR
