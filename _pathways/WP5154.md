...
- Lipids
- ONTOX
description: Docosahexaenoic acid (DHA) oxylipin metabolism, involving the LOX, COX2,
  and sEH genes.
...
- '@context': https://schema.org/
  ...
  creator:
    '@type': Organization
    name: WikiPathways
  description: Docosahexaenoic acid (DHA) oxylipin metabolism, involving the LOX,
    COX2, and sEH genes.
  keywords:
  - 10(11)-EpDPE
  - 10,11-DiHDPE
