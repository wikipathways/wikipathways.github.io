...
- link: 10.3389/fimmu.2021.769011
  title: 'A Practical Strategy for Exploring the Pharmacological Mechanism of Luteolin
    ...
    Analysis (2024)'
- link: PMC12948272
  title: 'CLinNET: An Interpretable and Uncertainty-Aware Deep Learning Framework
    for Multi-Modal Clinical Genomics (2026)'
- link: PMC11265978
...
description: Brain-derived neurotrophic factor (BDNF) is a neurotrophin essential
  ...
  have targeted assays available via the [CPTAC Assay Portal](https://assays.cancer.gov/available_assays?wp_id=WP2380).
...
- '@context': https://schema.org/
  ...
  description: Brain-derived neurotrophic factor (BDNF) is a neurotrophin essential
    ...
    cells.  Proteins on this pathway have targeted assays available via the [CPTAC
    Assay Portal](https://assays.cancer.gov/available_assays?wp_id=WP2380).
  keywords:
  - ACACB
  - ADAM17
  - AKT1
