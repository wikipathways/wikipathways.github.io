...
- link: PMC9524193
  title: Bioinformatics and systems biology approach to identify the pathogenetic
    link of Long COVID and Myalgic Encephalomyelitis/Chronic Fatigue Syndrome (2022)
communities:
- ONTOX
description: 'Dopamine is an organic chemical of the catecholamine and phenethylamine
  ...
  [Wikipedia](https://en.wikipedia.org/wiki/Dopamine).  Proteins on this pathway have
  targeted assays available via the [CPTAC Assay Portal](https://assays.cancer.gov/available_assays?wp_id=WP2436).'
...
- '@context': https://schema.org/
  ...
  description: 'Dopamine is an organic chemical of the catecholamine and phenethylamine
    ...
    barrier. Description source: [Wikipedia](https://en.wikipedia.org/wiki/Dopamine).  Proteins
    on this pathway have targeted assays available via the [CPTAC Assay Portal](https://assays.cancer.gov/available_assays?wp_id=WP2436).'
  keywords:
