...
description: Tyrosine kinase inhibitors (TKIs) are drugs that inhibit the phosphorylation,
  ...
  sites were added based on information from [PhosphoSitePlus](https://www.phosphosite.org).
...
- '@context': https://schema.org/
  ...
  description: Tyrosine kinase inhibitors (TKIs) are drugs that inhibit the phosphorylation,
    ...
    Protein phosphorylation sites were added based on information from [PhosphoSitePlus](https://www.phosphosite.org).
  keywords:
  - AKT1
  - AKT2
  - AKT3
