...
description: 'Pyrimidine metabolism disorders are caused by enzyme defects in the
  ...
  [IEMbase](http://www.iembase.org/), for all diseases pictured in WP4225. '
...
- '@context': https://schema.org/
  ...
  description: 'Pyrimidine metabolism disorders are caused by enzyme defects in the
    ...
    derived from [IEMbase](http://www.iembase.org/), for all diseases pictured in
    WP4225. '
  keywords:
