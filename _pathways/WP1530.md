...
description: 'This is the first of two pathways which deals with the DNA damage response.
  ...
  on this pathway have targeted assays available via the [CPTAC Assay Portal](https://assays.cancer.gov/available_assays?wp_id=WP1530). '
...
- '@context': https://schema.org/
  ...
  description: 'This is the first of two pathways which deals with the DNA damage
    ...
    assays available via the [CPTAC Assay Portal](https://assays.cancer.gov/available_assays?wp_id=WP1530). '
  keywords:
