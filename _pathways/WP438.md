...
description: Non-homologous end joining (NHEJ) is a pathway that repairs double-strand
  ...
  KEGG (https://www.genome.jp/dbget-bin/www_bget?pathway+hsa03450) and REPAIRtoire
  (http://repairtoire.genesilico.pl/Pathway/8/).  This pathway is part the [https://assays.cancer.gov/available_assays?wp_id=WP438
  CPTAC Assay Portal].
...
- '@context': https://schema.org/
  ...
  description: Non-homologous end joining (NHEJ) is a pathway that repairs double-strand
    ...
    from Wikipedia (http://en.wikipedia.org/wiki/Non-homologous_end_joining), KEGG
    (https://www.genome.jp/dbget-bin/www_bget?pathway+hsa03450) and REPAIRtoire (http://repairtoire.genesilico.pl/Pathway/8/).  This
    pathway is part the [https://assays.cancer.gov/available_assays?wp_id=WP438 CPTAC
    Assay Portal].
  keywords:
  - DCLRE1C
  - LIG4
