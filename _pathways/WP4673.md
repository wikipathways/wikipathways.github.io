...
description: Pathway(s) of genes involved in male infertility. The list of genes is
  derived from [Krausz *et al.*](http://www.ncbi.nlm.nih.gov/pubmed/26447148) and
  can be sorted in general (common) cell function, endocrine function and specific
...
- '@context': https://schema.org/
  ...
  description: Pathway(s) of genes involved in male infertility. The list of genes
    is derived from [Krausz *et al.*](http://www.ncbi.nlm.nih.gov/pubmed/26447148)
    and can be sorted in general (common) cell function, endocrine function and specific
    spermatogenic function.
  keywords:
  - ABCB1
  - ABLIM1
