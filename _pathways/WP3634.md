...
- link: PMC11502557
  title: MicroRNAs from edible plants reach the human gastrointestinal tract and may
    act as potential regulators of gene expression (2024)
communities: []
description: The paper (1) describes insulin signalling in human adipocytes under
  ...
  on this pathway have targeted assays available via the [CPTAC Assay Portal](https://assays.cancer.gov/available_assays?wp_id=WP3634).
...
- '@context': https://schema.org/
  ...
  description: The paper (1) describes insulin signalling in human adipocytes under
    ...
    manually.  Proteins on this pathway have targeted assays available via the [CPTAC
    Assay Portal](https://assays.cancer.gov/available_assays?wp_id=WP3634).
  keywords:
  - AS160
  - AS160p
  - GLUT4
