...
description: The cell cycle is the series of events that takes place in a cell leading
  ...
  a cell's progress through the cell cycle. From [Wikipedia](https://en.wikipedia.org/wiki/Cell_cycle).
...
- '@context': https://schema.org/
  ...
  description: The cell cycle is the series of events that takes place in a cell leading
    ...
    determine a cell's progress through the cell cycle. From [Wikipedia](https://en.wikipedia.org/wiki/Cell_cycle).
  keywords:
  - ABL1
  - ATM
  - ATR
