...
description: 'Synaptic signaling pathways associated with autism spectrum disorder
  ...
  from figure 1 from [Daghsni et al](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6085908/). '
...
- '@context': https://schema.org/
  ...
  description: 'Synaptic signaling pathways associated with autism spectrum disorder
    ...
    also associated with ASD and [Timothy Syndrome](https://en.wikipedia.org/wiki/Timothy_syndrome).  Adapted
    from figure 1 from [Daghsni et al](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6085908/). '
  keywords:
  - AKT1
  - AKT2
